...
function About () {
  return (
    <div className='text-container' >
      <h1>About</h1>
      <hr />
      <p>This is a guest post by Anne-Marie Pritchett, a freelance writer, storyteller and idea girl who has lived in six states and two countries. She has a great passion for sustainability and dancing in the rain. She writes handwritten letters to her parents and believes that music can connect souls.
...
Eco-tourist destinations are places where visitors can immerse themselves in the local culture while respecting nature and the geographic area’s local traditions.</p>
      <hr />
    </div>
  )
}

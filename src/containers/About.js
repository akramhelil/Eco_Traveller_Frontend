...
Eco-tourist destinations are places where visitors can immerse themselves in the local culture while respecting nature and the geographic area’s local traditions.</h4>
      <hr />
    </div>
  )
}
